...
//        val aNewPledge = A.database.transaction { A.services.loadState(newPledgeStateRef).data } as Pledge
//        val bNewPledge = B.database.transaction { B.services.loadState(newPledgeStateRef).data } as Pledge
//        val cNewPledge = C.database.transaction { C.services.loadState(newPledgeStateRef) }
//        val dNewPledge = D.database.transaction { D.services.loadState(newPledgeStateRef) }
//        val eNewPledge = E.database.transaction { E.services.loadState(newPledgeStateRef) }
